...
Misc.numHackathonOptions = {
    ...
    asArray: Object.keys(numHackathonOptions).map(idx => numHackathonOptions[idx]),
    getLabelForValue: value => (numHackathonOptions.hasOwnProperty(value) ? numHackathonOptions[value].label : '')
};

Misc.recruitmentStatuses = {
    items: recruitmentStatuses,
    asArray: Object.keys(recruitmentStatuses).map(id => recruitmentStatuses[id]),
    getLabelForValue: value => (recruitmentStatuses.hasOwnProperty(value) ? recruitmentStatuses[value].label : '')
};
