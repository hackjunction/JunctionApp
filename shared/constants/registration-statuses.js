const RegistrationStatuses = {
    ...
    acceptedToHub: {
        id: 'acceptedToHub',
        label: 'Accepted to Hub',
        description: 'Accepted to Hub and has been notified about it',
        color: '#33d068',
        allowAssign: false,
        allowEdit: false,
    },
    ...
    confirmedToHub: {
        id: 'confirmedToHub',
        label: 'Confirmed to Hub',
        description: 'Has confirmed their participation to Hub',
        color: '#ffc60a',
        allowAssign: false,
        allowEdit: false,
    },
