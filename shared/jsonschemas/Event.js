...
module.exports = {
    ...
    properties: {
        ...
        slug: {
            title: 'Slug',
            description: 'A unique slug for the event, to be used in e.g. URLs related to this event',
            type: 'string'
        },
        published: {
            title: 'Published',
        ...
        registrationStartTime: {
            ...
            description: 'The date & time when registration for the event begins',
            type: 'string',
            format: 'date-time'
        },
        registrationEndTime: {
        ...
        eventLocation: {
            ...
            description: 'The street address of the event. Required for events where eventType is physical',
        ...
        reviewMethod: {
            type: 'string',
            description: 'The reviewing method used to decide the track winners of the event, if applicable.'
        },
        overallReviewMethod: {
            type: 'string',
            description: 'The reviewing method used to decide the overall winners of the event, if applicable.'
        },
        userDetailsConfig: {
            type: 'object',
            description: 'A configuration object containing the questions to be asked in the registration form',
            properties: {
                todo: {
                    type: 'string'
                }
        ...
        customQuestions: {
            type: 'array',
            description: 'An array of additional custom questions to ask in the registration form',
            items: {
                type: 'object',
                properties: {
                    todo: {
        ...
        tags: {
            type: 'array',
            description: 'An array of tags which can be used to label event participants',
            items: {
                type: 'object',
                properties: {
                    todo: {
        ...
        galleryOpen: {
            type: 'boolean',
            description: 'Whether the project gallery for this event is open or not',
            default: false
        },
        owner: {
            type: 'string',
