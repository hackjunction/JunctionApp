...
export const adminRecruitersLoading = state => state.recruitment.adminRecruiters.loading;
export const adminRecruitersError = state => state.recruitment.adminRecruiters.error;
export const adminRecruitersUpdated = state => state.recruitment.adminRecruiters.updated;

export const adminRecruiters = createSelector(
    _adminRecruiters,
    recruiters => recruiters.filter(recruiter => recruiter.recruiterEvents.length > 0)
);

export const adminSearchResults = state => state.recruitment.adminSearchResults.data;
export const adminSearchResultsLoading = state => state.recruitment.adminSearchResults.loading;
export const adminSearchResultsError = state => state.recruitment.adminSearchResults.error;
export const adminSearchResultsUpdated = state => state.recruitment.adminSearchResults.updated;
