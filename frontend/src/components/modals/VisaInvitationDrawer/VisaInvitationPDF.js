...
const VisaInvitationPDF = ({
    ...
    <Document>
        <Page size="A4" style={styles.body}>
            <Image style={styles.topLeftLogo} src={require('assets/logos/wordmark_black_small.png')} />
            ...
            <Text style={styles.paragraph}>1) Junction 2019, from November 15th to 17th 2019</Text>
            <Text style={styles.paragraph}>
