...
const VisaInvitationDrawer = ({ defaults }) => {
    ...
    return (
        <React.Fragment>
            <Drawer anchor="right" width={640} onClose={handleClose} open={visible}>
                <Box p={3} width="100%" maxWidth={640}>
                    <Typography variant="body1" color="textPrimary" paragraph>
                        Just fill in a few more travel details and we'll generate a visa invitation letter for you. We
                        will not save this information for later use - in fact it is never sent anywhere from your
                        device.
                    </Typography>
                    <Typography variant="body1" color="textPrimary" paragraph>
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12}>
                            ...
                            <Typography width="100%" variant="caption" color="textSecondary">
                        ...
                        <Grid item xs={12}>
                            ...
                            <Box p={1} />
                            <Button variant="contained" color="theme_lightgray" fullWidth onClick={handleClose}>
                                Close
                            </Button>
                        </Grid>
                        <Grid item xs={12}>
