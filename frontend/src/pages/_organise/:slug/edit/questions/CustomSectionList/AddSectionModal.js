...
export default ({ visible, onVisibleChange, onSubmit, onEditDone, onEditCancel, editing, reservedNames }) => {
    ...
    return (
        ...
        >
            <DialogTitle id="form-dialog-title">{editing ? `Edit ${editing.label}` : 'Add a new section'}</DialogTitle>
            <DialogContent>
                ...
                <Typography variant="caption" width="100%" gutterBottom>
                    Do you want this section to be visible always, or have the user answer a yes/no question to expand
                    it?
                </Typography>
                <Box width="100%">
                    <FormControlLabel
                ...
                {isConditional && (
                    <React.Fragment>
                        ...
                        <Typography width="100%" variant="caption" gutterBottom>
                            What is the yes/no question you want to ask? When choosing yes, the questions in this
                            section will be shown
                        </Typography>
                        <TextInput
                            placeholder="Do you want to also apply to My Awesome Side Event?"
                            value={data.conditional}
                            onChange={value => handleChange('conditional', value)}
                        />
                    </React.Fragment>
                )}
            </DialogContent>
