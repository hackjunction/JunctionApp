        ...
        <PageWrapper loading={loading} error={error}>
            <Switch>
                ...
                <Route
                    ...
                    component={({ match }) => <GalleryDetail event={event} match={match} showFullTeam={true} />}
                />
                <Route
                    path={`${match.url}/challenge/:token`}
                    component={({ match }) => <GalleryChallengeAdmin projects={projects} event={event} match={match} />}
                />
                <Route path={match.url} component={() => <GalleryHome projects={projects} event={event} />} />
                <Redirect to="/" />
            </Switch>
        </PageWrapper>
    );
