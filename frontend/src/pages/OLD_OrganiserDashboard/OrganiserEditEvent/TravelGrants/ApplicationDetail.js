...
const ApplicationDetail = ({
    ...
    const [amount, setAmount] = useState(
        data ? data.travelGrantAmount : undefined
    )
    const [status, setStatus] = useState(
        data ? data.travelGrantStatus : undefined
    )
        ...
        return (
            <CenteredContainer>
                ...
                <Typography variant="body1">
                    This user has not submitted their travel grant details
                </Typography>
            </CenteredContainer>
        )
    }
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} lg={6}>
                        <Box display="flex" flexDirection="column">
                            ...
                            <Typography variant="body1">
                                {moment(
                                    data.travelGrantDetails.dateOfBirth
                                ).format('DD.MM.YYYY')}
                            </Typography>
                            ...
                            <Typography variant="body1" paragraphy>
                                {data.travelGrantDetails.address.postalCode}{' '}
                                {data.travelGrantDetails.address.city},{' '}
                            ...
                            data.travelGrantDetails.IBAN ? (
                                <>
                                    ...
                                    <Typography variant="body1">
                                        {data.travelGrantDetails.IBAN.swift}
                                    </Typography>
                                    <Typography variant="body1" gutterBottom>
                    ...
                    <Grid item xs={12} lg={6}>
                        ...
                        <Box className={classes.pdfActions}>
                            ...
                            <Button
                                onClick={() =>
                                    window.open(
                                        data.travelGrantDetails.receiptsPdf.url,
                                        '_blank'
                                    )
                                }
                            >
...
export default withSnackbar(
    connect(mapState, { updateRegistrationTravelGrant })(ApplicationDetail)
)
