    ...
    if (registration.status === STATUSES.rejected.id) {
        return (
            <NotificationBlock
                ...
                bottom={
                    <Button text="Event calendar" link={{ external: 'https://www.hackjunction.com/calendar' }} block />
                }
            />
        );
    }
                ...
                bottom={
                    <React.Fragment>
                        ...
                        <p style={{ textAlign: 'center' }}>
                            If something has gone horribly wrong and you've cancelled your registration in error, please
                            reach out to us at hello@hackjunction.com as soon as possible and we might be able to still
                            sort this out.
                        </p>
                    </React.Fragment>
                }
