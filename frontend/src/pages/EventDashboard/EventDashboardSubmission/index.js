            ...
            return (
                <GradientBox p={3} color="theme_orange">
                    ...
                    <Typography variant="body1" gutterBottom>
                        You need to join or create a team to submit a project! If you're participating alone, just
                        create a team where you are the only member and come back here.
                    </Typography>
                    <Button color="theme_white" variant="contained" onClick={() => editTeam(event.slug)}>
        ...
        if (!isTeamValid) {
            return (
                <GradientBox p={3} color="theme_orange">
                    ...
                    <Typography variant="body1" gutterBottom>
                        Looks like not everyone in your team has checked in to the event! Before submitting your
                        project, all of the members in your team must have checked in to the event. If your team still
                        contains members who are not participating at the event, please have the team owner remove them
                        from the team and then come back here.
                    </Typography>
                    <Button color="theme_white" variant="contained" onClick={() => editTeam(event.slug)}>
                        Edit your team
                    </Button>
            ...
            return (
                <GradientBox p={3} color="theme_white">
                    ...
                    <Typography variant="h4" color="primary" gutterBottom>
                        Submissions open {moment(event.submissionsStartTime).format('dddd MMM Do, hhA')}
                    </Typography>
                    <Typography variant="body1">
                        You can't submit your project yet - hang tight and come back here once the submission period has
                        opened!
                    </Typography>
                </GradientBox>
            );
                            ...
                            if (!completed) {
                                return (
                                    <React.Fragment>
                                        ...
                                        <Typography variant="h4" color="secondary" gutterBottom>
                                            Submissions close in {hours}:{minutes}:{seconds}
                                        </Typography>
                                        <Typography variant="body1">
                                            The submission period is open - remember to submit your project before the
                                ...
                                return (
                                    <React.Fragment>
                                        ...
                                        <Typography variant="body1">
                                            Alright, that's it! The submission period is now over and you can no longer
                                            make edits to your project. You can, however, still change some important
                                            details such as your table number to make sure people find your project -
                                            please make sure that it's always correct and up-to-date!
                                        </Typography>
                                    </React.Fragment>
                                );
                            }
