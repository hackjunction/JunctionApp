...
export const userProfileRecruiterEvents = state =>
    state.user.profile.recruiterEvents
export const userProfileRegistrations = state =>
    state.user.profile.registrations
